...
// Koneksi tanpa nama database dulu (untuk buat DB jika belum ada)
...
mysqli_query($conn, "CREATE DATABASE IF NOT EXISTS " . DB_NAME . " CHARACTER SET utf8 COLLATE utf8_general_ci");
mysqli_select_db($conn, DB_NAME);
mysqli_set_charset($conn, "utf8");

// =============================================
// Buat Tabel & Isi Data Jika Belum Ada
// =============================================

// Tabel profil
mysqli_query($conn, "CREATE TABLE IF NOT EXISTS profil (
...
// Tabel keahlian
mysqli_query($conn, "CREATE TABLE IF NOT EXISTS keahlian (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nama VARCHAR(100) NOT NULL,
...
// Tabel proyek
mysqli_query($conn, "CREATE TABLE IF NOT EXISTS proyek (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
// Tabel pesan kontak
mysqli_query($conn, "CREATE TABLE IF NOT EXISTS pesan_kontak (
    id INT AUTO_INCREMENT PRIMARY KEY,
    nama VARCHAR(100) NOT NULL,
    email VARCHAR(100) NOT NULL,
...
// =============================================
$cek = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as total FROM profil"));
if ($cek['total'] == 0) {
    mysqli_query($conn, "INSERT INTO profil (nama, jabatan, tentang, email, telepon, lokasi, github) VALUES (
        'Budi Santoso',
    ...
    mysqli_query($conn, "INSERT INTO keahlian (nama, persentase, kategori) VALUES
        ('PHP', 85, 'backend'),
        ('MySQL', 80, 'database'),
    ...
    mysqli_query($conn, "INSERT INTO proyek (judul, deskripsi, teknologi, link_demo, link_github, urutan) VALUES
